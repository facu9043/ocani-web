        ...
        <div className="space-y-6">
          <div className="rounded-2xl border border-forest-dark/10 bg-sage p-6">
            ...
            <a
              ...
              className="mt-2 inline-block text-sm font-semibold text-forest hover:text-forest-dark"
            >
              +54 3624 15-8218
            </a>

            <h2 className="mt-5 font-display text-lg font-semibold text-forest-dark">
              Instagram
            </h2>
            <a
              href={instagramUrl}
            ...
            <p className="mt-2 text-sm text-ink/80">{businessHours}</p>

            <h2 className="mt-5 font-display text-lg font-semibold text-forest-dark">
              Dirección
            </h2>
            <p className="mt-2 text-sm text-ink/80">{address}</p>
          </div>
